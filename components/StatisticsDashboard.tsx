    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-fade-in">
      <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
          <div>
            <h2 className="text-xl font-bold text-slate-800">Thống kê Sức khỏe</h2>
            <p className="text-slate-500 text-sm">Theo dõi sự kiên trì của bạn</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto no-scrollbar">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-orange-50 p-5 rounded-2xl border border-orange-100 flex flex-col items-center justify-center">
              ...
              <span className="text-xs text-slate-500 mt-1">ngày liên tiếp</span>
            </div>
            ...
            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100 flex flex-col items-center justify-center">
              ...
              <span className="text-4xl font-bold text-slate-800">{totalMinutes}</span>
              <span className="text-xs text-slate-500 mt-1">phút tịnh tâm</span>
            </div>
          </div>
